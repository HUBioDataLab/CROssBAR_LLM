...
with gr.Blocks(css=css) as interface:
    with gr.Column():
        ...
        query_llm_type = gr.Dropdown(["gpt-3.5-turbo-instruct", "gemini-pro"], label="LLM choice (Select the large language model to be utilised for processing your query from the dropdown menu)", value="gpt-3.5-turbo-instruct")
    ...
    with gr.Column():    
        ...
        natural_llm_type = gr.Dropdown(["gpt-3.5-turbo-instruct", "gemini-pro"], label="LLM choice (Select the large language model to be utilised for returning the natural language answer from the dropdown menu)", value="gpt-3.5-turbo-instruct")
