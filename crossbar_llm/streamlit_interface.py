...
def query_interface(file_upload=False):
    ...
    with col2:
        ...
        with st.expander("Top 5 Node Labels", expanded=False):
            ...
            st.plotly_chart(fig1, use_container_width=True, key=f"top_5_labels{'_file' if file_upload else ''}")
        ...
        with st.expander("Top 5 Relationship Types", expanded=False):
            ...
            st.plotly_chart(fig2, use_container_width=True, key=f"top_5_relationships{'_file' if file_upload else ''}")
